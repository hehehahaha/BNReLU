...
typedef ap_uint<1> datatype_control;
typedef int8_t datatype_kernel;
//typedef int<1> datatype_kernel;
typedef int8_t datatype_Input_layer;
typedef int8_t datatype_Convolution_layer;
typedef int8_t datatype_Max_Pool;
typedef int8_t datatype_BN;
typedef int8_t datatype_Relu;
