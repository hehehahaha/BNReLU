...
int rdMNISTs28_train(int begin_num, int end_num, T data_o[][28][28], int _label[])
{
	...
	char imagefile[] = "D:\\MNIST\\train-images.idx3-ubyte";
	char labelfile[] = "D:\\MNIST\\train-labels.idx1-ubyte";
...
int rdMNISTs28_test(int begin_num, int end_num, T data_o[][28][28], int _label[])
{
	...
	char imagefile[] = "D:\\MNIST\\t10k-images.idx3-ubyte";
	char labelfile[] = "D:\\MNIST\\t10k-labels.idx1-ubyte";
	fp = fopen(imagefile, "rb");
	if (fp == NULL)
	{
