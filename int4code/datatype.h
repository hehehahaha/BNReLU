...
typedef ap_uint<1> datatype_control;
typedef int datatype_kernel;
//typedef int<1> datatype_kernel;
typedef int datatype_Input_layer;
typedef int datatype_Convolution_layer;
typedef int datatype_Max_Pool;
typedef int datatype_BN;
typedef int datatype_Relu;
